...
import { CreateTaskRequest, TaskMap, TaskObject, UpdateTaskRequest } from '../../models/task';
...
export class TaskService {
  ...
  getTasksByProjectId(projectId: string): Promise<TaskMap> {
    const accessToken = localStorage.getItem("access-token");
    ...
    return firstValueFrom(this.http.get<TaskMap>(url, { headers }));
  }
